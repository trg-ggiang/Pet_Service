---
title: Phase 03 - Database Design
description: Plan for designing the initial data model and database relationships.
---
...
- `docs/BRD.mdx` neu can cap nhat data rules
- `docs/CHANGELOG.mdx` neu co thay doi schema quan trong
