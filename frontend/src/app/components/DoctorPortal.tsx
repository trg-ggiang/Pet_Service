...
const SCHEDULE = [
  { id: "APT-001", time: "08:30", patient: "Mochi",    species: "Chó", owner: "Nguyễn Thị Mai",  service: "Khám tổng quát",  status: "completed",   room: "P.1" },
  { id: "APT-002", time: "09:00", patient: "Kiwi",     species: "Mèo", owner: "Phạm Văn Đức",   service: "Tiêm phòng dại",  status: "completed",   room: "P.1" },
  { id: "APT-004", time: "10:00", patient: "Luna",     species: "Mèo", owner: "Trần Minh Khoa", service: "Khám da liễu",    status: "in_progress", room: "P.1" },
  { id: "APT-007", time: "11:30", patient: "Snowball", species: "Mèo", owner: "Đặng Quốc Hùng", service: "Tiêm combo mèo",  status: "scheduled",   room: "P.1" },
  { id: "APT-012", time: "14:00", patient: "Nala",     species: "Mèo", owner: "Trịnh Thị Nga",  service: "Kiểm tra định kỳ", status: "scheduled",  room: "P.1" },
  { id: "APT-015", time: "15:30", patient: "Biscuit",  species: "Chó", owner: "Lê Minh Phúc",   service: "Khám nội khoa",   status: "scheduled",   room: "P.1" },
];
...
export function DoctorPortal({ onLogout }: { onLogout: () => void }) {
  ...
  const [examPatient, setExamPatient] = useState<typeof SCHEDULE[0] | null>(null);
        ...
        <div className="px-5 py-4 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="text-xs font-bold text-foreground truncate">BS. Trần Hoài Nam</div>
              <div className="text-[10px] text-muted-foreground">Nội khoa · Phòng 1</div>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {!examPatient && activeNav === "schedule" && <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            {[
              { label: "Tổng ca hôm nay", value: SCHEDULE.length, icon: Calendar, bg: "bg-blue-50", color: "text-blue-600" },
