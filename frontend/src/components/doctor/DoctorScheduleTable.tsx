                ...
                <div className="flex items-center justify-end gap-3 w-[236px] flex-shrink-0">
                  ...
                  <div className="w-28 flex justify-end">
                    {row.statusKey !== "completed" ? (
                      ...
                      <button
                        onClick={() => onOpenExam(appointment)}
                        className="flex w-28 items-center justify-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-colors border border-cyan-200 text-cyan-600 hover:bg-cyan-50/50 flex-shrink-0"
                      >
                        <span className="truncate">Xem bệnh án</span> <ChevronRight size={12} />
                      </button>
                    )}
                  </div>
                </div>
